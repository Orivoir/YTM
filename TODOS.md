...
- [ ] component `AlbumDetails` is laggy/jerky, the `SelectPlaylist` modal should be unique into **App**, render at Routing component and open/close with `DeviceEventEmitter`
